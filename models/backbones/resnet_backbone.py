...
def ResNetBackbone(backbone=None, pretrained=None, multi_grid=None, norm_type='syncbatchnorm'):
    arch =  backbone
    if arch == 'resnet34':
        ...
        if pretrained:
            pretrained = 'models/backbones/pretrained/3x3resnet50-imagenet.pth'
        orig_resnet = deepbase_resnet50(pretrained=pretrained) #resNet50
        arch_net = DilatedResnetBackbone(orig_resnet, dilate_scale=8, multi_grid=multi_grid)#空洞卷积的尺寸是8，并且进行了PSP融合
